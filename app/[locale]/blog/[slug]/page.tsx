...
const BLOG_POSTS: Record<string, BlogPost> = {
  'ai-automation-2026': { titleKey: 'post1Title', date: '2026-02-28', dateModified: '2026-04-30', namespace: 'BlogPage', prefix: 'post1', sections: 4, tags: ['AI automation', 'business automation', 'small business'], section: 'AI Automation', links: [{ href: '/services/automations', labelKey: 'linkAuto' }, { href: '/services/web', labelKey: 'linkWeb' }, { href: '/pricing', labelKey: 'linkPricing' }] },
  'website-cost-guide': { titleKey: 'post2Title', date: '2026-02-20', dateModified: '2026-04-30', namespace: 'BlogPage', prefix: 'post2', sections: 4, tags: ['web design', 'website cost', 'pricing'], section: 'Web Design', links: [{ href: '/services/web', labelKey: 'linkWeb' }, { href: '/pricing', labelKey: 'linkPricing' }, { href: '/contact', labelKey: 'linkContact' }] },
  'whatsapp-ai-automation': { titleKey: 'post3Title', date: '2026-02-12', dateModified: '2026-04-30', namespace: 'BlogPage', prefix: 'post3', sections: 4, tags: ['WhatsApp', 'AI chatbot', 'customer service'], section: 'AI Automation', links: [{ href: '/services/automations', labelKey: 'linkAuto' }, { href: '/services/marketing', labelKey: 'linkMarketing' }, { href: '/pricing', labelKey: 'linkPricing' }] },
  'local-seo-guide': { titleKey: 'post4Title', date: '2026-02-05', dateModified: '2026-04-30', namespace: 'BlogPage', prefix: 'post4', sections: 4, tags: ['local SEO', 'Google Maps', 'digital marketing'], section: 'Marketing', links: [{ href: '/services/marketing', labelKey: 'linkMarketing' }, { href: '/services/web', labelKey: 'linkWeb' }, { href: '/contact', labelKey: 'linkContact' }] },
