...
export async function generateMetadata({
  ...
  const keywords = locale === 'es'
    ? ['automatización IA', 'chatbot WhatsApp', 'automatización de flujos', 'CRM automático', 'automatización de procesos']
    : ['AI automation', 'WhatsApp chatbot', 'workflow automation', 'CRM automation', 'business process automation'];
  return {
    title,
    description,
    keywords,
